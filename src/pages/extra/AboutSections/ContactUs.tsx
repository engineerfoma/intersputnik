        ...
        <Container>
          <Row className="about-us-row text-center align-items-center">
            ...
            <Col lg="6" md="7">
              ...
              <p className="mb-0 text-start">fara is located in Los Angeles city and you can contact us at <Link href="mailto:info@medyapim.com">hello@fara.com</Link> for any tech-related support and assistance. We love to hear from our fara users.</p>
