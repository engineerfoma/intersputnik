                        ...
                        <Row>
                            <Col lg="4" sm="6">
                                <div className='footer-inner'>
                                    ...
                                    <span className='d-inline-block mt-4 mb-0 font-size-14'> Email Us: <Link href="maito:customer@fara.com">customer@fara.com</Link></span>
                                    <div className="mt-5">
                    ...
                    <Container fluid>
                        <Row className="align-items-center">
                            <Col md="6" className="text-md-start text-center">
                                <p className="m-0 font-size-14 text-capitalize">© <span className="currentYear">{currentYear}</span><Link href="/"> fara </Link> All rights reserved.</p>
                            </Col>
